...
function ejercicioA(respuesta) {
	...
	ejercicio2.innerHTML = "<b>a. Crear un script que determine a partir del fichero JSON cuál es el libro de mayor precio: </b> </br></br> ";
	ejercicio2.innerHTML += '"' + cocheMax.marca + " " + cocheMax.modelo + '" es el coche de mayor precio, ya que vale: ' + a.precioMaximo().precio + "$</br></br></br>";
...
function ejercicioB(respuesta) {
	...
	ejercicio3.innerHTML = "<b>b. Crear una plantilla utilizando el plugin de handlebars para representar los datos JSON en una tabla </b> </br></br>";
